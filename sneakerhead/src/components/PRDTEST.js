                    ...
                    <Form onSubmit={this.handleSubmit}>
                        ...
                        <Col lg={6}>
                                <Form.Group className="mb-3">
                                    <Form.Label>Customer ID (Example: 101)</Form.Label>
                            ...
                            <Col lg={6}>
                                <Form.Group className="mb-3">
                                    <Form.Label>Your Name (Example: Gajala Apradh)</Form.Label>
                            ...
                            <Col lg={6}>
                                <Form.Group className="mb-3">
                                    <Form.Label>Brand Name (Example : Bata)</Form.Label>
                            ...
                            <Col lg={6}>
                                <Form.Group className="mb-3">
                                    <Form.Label>Phone (Valid Indian Number)</Form.Label>
                            ...
                            <Col lg={6}>
                                <Form.Group className="mb-3">
                                    <Form.Label>Expected Average Price INR (Example: 4999)</Form.Label>
                            ...
                            <Col lg={6}>
                                <Form.Group className="mb-3">
                                    <Form.Label>Email (Gajala@mail.com)</Form.Label>
